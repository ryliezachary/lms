                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right">
										     ...
										     <a href="add_posttest.php<?php echo '?qtype=posttest&id='.$get_id; ?>" class="btn btn-success"><i class="icon- plus-sign"></i> Add Question</a>
		...
		<form action="delete_quiz_question.php" method="post">
									...
									<?php include('modal_delete_quiz_question.php'); ?>
                              		...
                              		<?php
										...
										where quiz_id = '$get_id' and qtype='posttest'  order by date_added DESC ")or die(mysql_error());
